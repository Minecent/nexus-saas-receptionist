...
const posts = [
  {
    ...
    description: 'Ruby bundles live receptionist minutes and bills per minute. NEXUS answers 24/7/365 on a flat monthly plan. Full feature comparison.',
    badge: 'Comparison',
    date: 'April 2026',
  },
  {
    ...
    description: 'Smith.ai blends AI with human agents and bills per call. NEXUS is a flat monthly plan with no per-call fees. Side-by-side breakdown.',
    badge: 'Comparison',
    date: 'April 2026',
  },
  {
  ...
  },
  {
    ...
    description: 'Davinci Virtual provides live receptionist minutes during business hours only. NEXUS answers 24/7/365 on a flat monthly plan.',
    badge: 'Comparison',
    date: 'April 2026',
  },
  {
    ...
    description: 'PATLive bundles live minutes with per-minute overage fees. NEXUS is flat-rate with 24/7/365 AI answering.',
    badge: 'Comparison',
    date: 'April 2026',
  },
  {
    ...
    description: 'Abby Connect bundles live answering minutes during staffed hours. NEXUS handles unlimited simultaneous calls with 24/7/365 coverage.',
    badge: 'Comparison',
    date: 'April 2026',
  },
]
