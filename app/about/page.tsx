...
export const metadata: Metadata = {
  ...
  description:
    'NEXUS AI builds AI-powered receptionists for small businesses. Learn about our mission to make professional phone answering accessible to every business, not just the ones with big budgets.',
}
...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-slate-900">
      ...
      <main>
        {/* Hero */}
        <section className="border-b border-slate-800 bg-slate-950 px-4 py-24 sm:px-6">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="text-lg leading-relaxed text-slate-400">
              NEXUS started with a simple observation: small businesses lose thousands of dollars
        ...
        {/* Mission */}
        <section className="border-b border-slate-800 bg-slate-900 px-4 py-20 sm:px-6">
