...
const organizationSchema = {
  ...
  "description": "AI receptionist service that answers calls 24/7, books appointments, takes messages, and handles customer inquiries for small businesses. Starts at $25/month.",
  "contactPoint": [
    {
      "@type": "ContactPoint",
      "contactType": "sales",
...
const softwareSchema = {
  ...
  "alternateName": "NEXUS",
  "url": siteUrl,
  "description": "AI-powered phone answering service for small businesses. Answers calls 24/7, books appointments via Google Calendar, qualifies leads, sends call summaries, and integrates with 7,000+ apps via Zapier.",
  ...
  "offers": [
    {
      ...
      "price": "25.00",
      "priceCurrency": "USD",
      "description": "30 calls/month with 24/7 AI answering, Google Calendar booking, email summaries",
  ...
  "mainEntity": [
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "NEXUS answers calls in 1 ring, 24/7. It collects caller information, answers questions about your business, books appointments, qualifies leads, and sends you instant summaries after every call. It can also transfer urgent calls to you or your team when needed.",
      },
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. NEXUS answers calls 24/7, including nights, weekends, and public holidays. Every lead that calls outside your office hours gets answered, qualified, and logged.",
      },
    },
    {
      "@type": "Question",
...
const websiteSchema = {
  ...
  "name": "NEXUS AI Receptionist",
  "url": siteUrl,
  "description": "AI receptionists that never miss a call. Answer calls 24/7, book appointments, take messages.",
};
