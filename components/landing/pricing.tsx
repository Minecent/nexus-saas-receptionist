          ...
          <div className="mt-6 inline-flex items-center gap-1 rounded-full border border-slate-700 bg-slate-800 p-1">
            <button
              ...
              className={cn(
                ...
                !isAnnual ? 'bg-slate-700 text-white' : 'text-slate-100 hover:text-white'
              )}
            >
              Monthly
            </button>
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {tiers.map((tier) => (
            ...
            >
              ...
              {/* Overage */}
              {tier.overage && (
                <div className="mb-4 rounded-lg border border-slate-700 bg-slate-900 px-3 py-2 text-xs text-slate-300">
                  {tier.overage}
                </div>
              )}
