...
export default function Features() {
  return (
    <section id="features" className="border-b border-slate-600 bg-slate-700">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {features.map((feature) => {
            ...
            return (
              <div
                key={feature.title}
                className="rounded-2xl border border-slate-700 bg-slate-800 p-6 transition-all hover:-translate-y-1 hover:border-teal-500/40 hover:shadow-lg hover:shadow-teal-500/5"
              >
